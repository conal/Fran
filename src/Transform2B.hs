...
rotate2    = lift1 T.rotate2 (noI "rotate2")
compose2   = lift2 T.compose2 (noI "compose2 ")
inverse2   = lift1 T.inverse2 (noI "inverse2")
uscale2    = lift1 T.uscale2 (noI "uscale2")

translate2 :: T.Translateable2 a => Behavior a -> Transform2B
translate2 =  lift1 T.translate2 (noI "translate2")

scale2 :: T.Scaleable2 a => Behavior a -> Transform2B
scale2 =  lift1 T.scale2 (noI "scale2")
