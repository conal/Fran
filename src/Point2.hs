...
data Point2 = Point2XY RealVal RealVal   deriving (Eq, Text)
...
pointPlusVector2 :: Point2 -> Vector2 -> Point2
pointPlusVector2  (Point2XY x y) (Vector2XY dx dy) = Point2XY (x+dx) (y+dy)

pointMinusVector2 :: Point2 -> Vector2 -> Point2
pointMinusVector2 (Point2XY x y) (Vector2XY dx dy) = Point2XY (x-dx) (y-dy)

pointMinusPoint2 :: Point2 -> Point2 -> Vector2
pointMinusPoint2 (Point2XY x1 y1) (Point2XY x2 y2) = vector2XY (x1-x2) (y1-y2)
